...
final timeMin1Style = GoogleFonts.poppins(fontSize: 144, fontWeight: FontWeight.w700, height: 0.9, color: Colors.black);
final timeSec1Style = GoogleFonts.poppins(fontSize: 144, fontWeight: FontWeight.w300, height: 0.9, color: Colors.black);
final timeDisplay2Style =
    GoogleFonts.poppins(fontSize: 128, fontWeight: FontWeight.w700, height: 0.9, color: Colors.black);
final timeDisplay3Style =
    GoogleFonts.poppins(fontSize: 64, fontWeight: FontWeight.w400, height: 0.9, color: Colors.black);
final timeDisplay4Style =
    GoogleFonts.poppins(fontSize: 36, fontWeight: FontWeight.w400, height: 0.9, color: Colors.black);
